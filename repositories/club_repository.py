...
class ClubRepository:
    def __init__(self):
        self.fm = FileManager()
        self.clubs_file = "clubs.csv"
        self.offices_file = "offices.csv"
    ...
    def _write_csv(self, filename: str, rows: List[Dict[str,str]], fieldnames: List[str]):
            self.fm.write_csv(filename, rows, fieldnames)